...
import openpi.training.trainer as _trainer
...
# Keep these public names stable for callers and tests while sharing the
# implementation with the pretraining entrypoint.
init_train_state = _trainer.init_train_state
train_step = _trainer.train_step
